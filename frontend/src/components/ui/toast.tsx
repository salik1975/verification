...
>(({ className, variant, ...props }, ref) => {
  ...
  return (
    <ToastPrimitives.Root
      ...
      style={{
        border: variant === "destructive" ? undefined : `2px solid ${appearance.primaryColor}`,
        background: variant === "destructive" ? undefined : `linear-gradient(135deg, ${appearance.primaryColor}15 0%, ${appearance.primaryColor}25 100%)`,
      }}
      {...props}
    />
  )
